...
!     ---------- ----
      ...
      DOUBLE PRECISION e0,r,v0,c,eps,sigm,dsigm,s
      INTEGER i,j
       ...
       F(2)= y4
       F(3)= y5
       F(4)= a1*a0*sigm(y1-y2) - 2*a0*y3 - a0**2*y0
       F(5)= a1*a0*(p + eps*sigm(y1-y2)  + c2*sigm(C1*y0)) - 2*a0*y4 - a0**2*y1
       F(6)= b1*b0*c4*sigm(c3*y0) -2*b0*y5 - b0**2*y2
